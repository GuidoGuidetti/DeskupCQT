  ...
  return (
    <DashboardLayout>
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="mb-8">
          <h2 className="text-2xl font-bold text-gray-900">Crea Nuovo Cliente</h2>
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <select
                id="partner"
                name="partner"
                defaultValue={session.usr_role === 1 ? session.usr_part_id?.toString() : ''}
              ...
              {session.usr_role === 1 && (
                <p className="text-xs text-gray-500 mt-1">
                  Il partner viene assegnato automaticamente al tuo account
                </p>
              )}
            </div>
