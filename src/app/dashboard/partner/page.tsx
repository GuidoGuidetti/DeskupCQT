...
import { BuildingIcon, TicketIcon, CreditCardIcon } from 'lucide-react';

export default async function PartnerDashboard() {
  // Only allow role 1 (partner)
  await requireRole([1]);
  ...
  return (
    <DashboardLayout>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="mb-8">
          <h2 className="text-3xl font-bold text-gray-900 mb-2">Dashboard Partner</h2>
          <p className="text-gray-600">Gestisci clienti, carnets e tickets</p>
        </div>
